    ...
    <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
        ...
        <div class="flex flex-col">
            ...
            @guest
                ...
                <p class="uppercase text-xs text-gray-600 mb-4 tracking-wider">For the Guest</p>
            ...
            @else
                ...
                <strong class="uppercase text-xs text-gray-600 mb-4 tracking-wider">You are logged in as Admin</strong>
                <a href="" class="mb-3 capitalize font-medium text-sm hover:text-teal-600
                 transition ease-in-out duration-500"></a>
                ...
                <!-- link -->
                <a href="{{ __('home') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
                    Home
                </a>
                <!-- end link -->

                <!-- link -->
                <a href="{{ __('profile') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
                    About Me
                </a>
                <!-- end link -->
